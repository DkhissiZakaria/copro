...
public class CreateSyndicDto {
    ...
    public String getCarteProfessionnelle() {
        return carteProfessionnelle;
    }

    public void setCarteProfessionnelle(String carteProfessionnelle) {
    ...
    public String getLogoCoordonneesPath() {
        return logoCoordonneesPath;
    }

    public void setLogoCoordonneesPath(String logoCoordonneesPath) {
        this.logoCoordonneesPath = logoCoordonneesPath;
    }

    public String getLogoSimplePath() {
        return logoSimplePath;
    }

    public void setLogoSimplePath(String logoSimplePath) {
    ...
    public String getSocieteGarant() {
        return societeGarant;
    }

    public void setSocieteGarant(String societeGarant) {
        this.societeGarant = societeGarant;
    }

    public String getNumeroTeleDeclarant() {
        return numeroTeleDeclarant;
    }

    public void setNumeroTeleDeclarant(String numeroTeleDeclarant) {
        this.numeroTeleDeclarant = numeroTeleDeclarant;
    }

    public String getMailTeleDeclarant() {
        return mailTeleDeclarant;
    }

    public void setMailTeleDeclarant(String mailTeleDeclarant) {
        this.mailTeleDeclarant = mailTeleDeclarant;
    }
    ...
    public String getDocCarteProfessionnellePath() {
        return docCarteProfessionnellePath;
    }

    public void setDocCarteProfessionnellePath(String docCarteProfessionnellePath) {
        this.docCarteProfessionnellePath = docCarteProfessionnellePath;
    }

    public String getDocAssuranceRcPath() {
        return docAssuranceRcPath;
    }

    public void setDocAssuranceRcPath(String docAssuranceRcPath) {
        this.docAssuranceRcPath = docAssuranceRcPath;
    }

    public String getDocGarantieFinancierePath() {
        return docGarantieFinancierePath;
    }

    public void setDocGarantieFinancierePath(String docGarantieFinancierePath) {
        this.docGarantieFinancierePath = docGarantieFinancierePath;
    }

    public String getDocTamponSignaturePath() {
        return docTamponSignaturePath;
    }

    public void setDocTamponSignaturePath(String docTamponSignaturePath) {
        this.docTamponSignaturePath = docTamponSignaturePath;
    }
